...
<x-layout.users-layout>
                    ...
                    <div id="latest-activity-1" class="card">
                        ...
                        <div class="card-body no-padding">
                            ...
                            <div class="page-block">
                                <img src="../assets/img/Home/ninga.svg" data-demo-src="../assets/img/Home/ninga.svg" data-page-popover="5" alt="" />
                                <div class="page-meta">
                                    <span>Css Ninja</span>
                            ...
                            <!-- Recommended Page -->
                            <div class="page-block">
                                <img src="../assets/img/Home/edward.jpeg" data-demo-src="../assets/img/Home/edward.jpeg" alt="" data-user-popover="7" />
                                <div class="page-meta">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="modal-trigger" data-modal="albums-help-modal">
                                            <img src="../assets/img/Home/book_icons.svg" />
                            ...
                            <div class="tab-content">
                                ...
                                <div class="compose">
                                    <div class="compose-form">
                                        <img src="../assets/img/Home/jenna.png" data-demo-src="../assets/img/Home/jenna.png" alt="user" />
                                        <div class="control">
                                    ...
                                    <div id="gif-suboption" class="is-autocomplete is-suboption is-hidden">
                                        <div id="gif-autocpl-wrapper" class="control is-gif-wrapper has-margin">
                                            ...
                                            <div class="gif-dropdown">
                                                <div class="inner">
                                                    <div class="gif-block">
                                                        <img src="https://via.placeholder.com/478x344" alt="" />
                                                        <img src="https://via.placeholder.com/478x344" alt="" />
                                                        <img src="https://via.placeholder.com/478x344" alt="" />
                                                        <img src="https://via.placeholder.com/478x344" alt="" />
                                                    </div>
                          ...
                          <i data-feather="search"></i>
                                        ...
                                        <div class="list-body">
                                            ...
                                            <div class="friend-block">
                                                ...
                                                <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/dan.jpg" alt="" />
                                            ...
                                            <div class="friend-block">
                                                ...
                                                <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/daniel.jpg" alt="" />
                                            ...
                                            <div class="friend-block">
                                                ...
                                                <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/stella.jpg" alt="" />
                                            ...
                                            <div class="friend-block">
                                                ...
                                                <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/gaelle.jpeg" alt="" />
                                            ...
                                            <div class="friend-block">
                                                ...
                                                <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/nelly.png" alt="" />
                        ...
                        <div class="content-wrap">
                            ...
                            <div class="card-heading">
                                ...
                                <div class="user-block">
                                    <div class="image">
                                        <img src="../assets/img/Home/bobby.jpg" data-demo-src="../assets/img/Home/bobby.jpg" data-user-popover="1" alt="" />
                                    </div>
                                    <div class="user-info">
                                        <a href="#">Dan Walker</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="post-image">
                                    <a data-fancybox="post1" data-lightbox-type="comments" data-thumb="" href="https://via.placeholder.com/1600x900" data-demo-href="">
                                        <img src="../assets/img/Home/1.jpg" data-demo-src="../assets/img/Home/1.jpg" alt="" />
                                    </a>
                                    <!-- Action buttons -->
                                    ...
                                    <div class="fab-wrapper is-share">
                                        <a href="javascript:void(0);" class="small-fab share-fab modal-trigger bg-main" data-modal="share-modal">
                                            <i data-feather="link-2"></i>
                                        </a>
                                    </div>

                                    <div class="fab-wrapper is-comment" >
                                        <a href="javascript:void(0);" class="small-fab bg-main">
                            ...
                            <div class="card-footer">
                                ...
                                <div class="likers-group">
                                    <img src="../assets/img/Home/bobby.jpg" data-demo-src="../assets/img/Home/bobby.jpg" data-user-popover="1" alt="" />
                                    <img src="../assets/img/Home/bobby.jpg" data-demo-src="../assets/img/Home/bobby.jpg" data-user-popover="4" alt="" />
                                    <img src="../assets/img/Home/bobby.jpg" data-demo-src="../assets/img/Home/bobby.jpg" data-user-popover="5" alt="" />
                                    <img src="../assets/img/Home/bobby.jpg" data-demo-src="../assets/img/Home/bobby.jpg" data-user-popover="7" alt="" />
                                </div>
                                <!-- Followers text -->
                            ...
                            <div class="comments-body has-slimscroll">
                                ...
                                <div class="media is-comment">
                                    ...
                                    <div class="media-left">
                                        <div class="image">
                                            <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/dan.jpg" data-user-popover="1" alt="" />
                                        </div>
                                    </div>
                                    <!-- Content -->
                                    <div class="media-content">
                                        ...
                                        <div class="media is-comment">
                                            ...
                                            <div class="media-left">
                                                <div class="image">
                                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/gaelle.jpeg" data-user-popover="4" alt="" />
                                                </div>
                                            </div>
                                            <!-- Content -->
                                            <div class="media-content">
                                ...
                                <div class="media is-comment">
                                    ...
                                    <div class="media-left">
                                        <div class="image">
                                            <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/rolf.jpg" data-user-popover="13" alt="" />
                                        </div>
                                    </div>
                                    <!-- Content -->
                                    <div class="media-content">
                                        ...
                                        <div class="media is-comment">
                                            ...
                                            <div class="media-left">
                                                <div class="image">
                                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/elise.jpg" data-user-popover="6" alt="" />
                                                </div>
                                            </div>
                                            <!-- Content -->
                                            <div class="media-content">
                                ...
                                <div class="media is-comment">
                                    ...
                                    <div class="media-left">
                                        <div class="image">
                                            <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/lana.jpeg" data-user-popover="10" alt="" />
                                        </div>
                                    </div>
                                    <!-- Content -->
                                    <div class="media-content">
                                    ...
                                    <div class="media-content">
                                        ...
                                        <div class="actions">
                                            <div class="image is-32x32">
                                                <img class="is-rounded" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/jenna.png" data-user-popover="0" alt="" />
                                            </div>
                                            <div class="toolbar">
                    ...
                    <div class="card is-post">
                        ...
                        <div class="content-wrap">
                            ...
                            <div class="card-heading">
                                ...
                                <div class="user-block">
                                    <div class="image">
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/dan.jpg" data-user-popover="5" alt="" />
                                    </div>
                                    <div class="user-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="post-link is-video">
                                    ...
                                    <div class="link-image">
                                        <img src="../assets/img/Home/videoBooster.jpg" data-demo-src="../assets/img/Home/videoBooster.jpg" alt="" />
                            ...
                            <div class="card-footer">
                                <!-- Followers -->
                                <div class="likers-group">
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/daniel.jpg" data-user-popover="3" alt="" />
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/elise.jpg" data-user-popover="6" alt="" />
                                </div>
                                <div class="likers-text">
                                    <p>
                    ...
                    <div class="card is-post">
                        ...
                        <div class="content-wrap">
                            ...
                            <div class="card-body">
                                ...
                                <div class="post-image">
                                    <a data-fancybox="post2" data-lightbox-type="comments" data-thumb="../assets/img/demo/unsplash/2.jpg" href="https://via.placeholder.com/1600x900" data-demo-href="../assets/img/demo/unsplash/2.jpg">
                                        <img src="../assets/img/Home/2.jpg" data-demo-src="../assets/img/Home/2.jpg" alt="" />
                                    </a>
                                    <!-- Post actions -->
                                    <!-- /partials/pages/feed/buttons/feed-post-actions.html -->
                                    <div class="like-wrapper">
                            ...
                            <div class="card-footer">
                                <!-- Followers -->
                                <div class="likers-group">
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/gaelle.jpeg" data-user-popover="11" alt="" />
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/dan.jpg" data-user-popover="5" alt="" />
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/nelly.png" data-user-popover="9" alt="" />
                                </div>
                                <div class="likers-text">
                                    <p>
                                        <a href="#">Gaelle</a>,
                    ...
                    <div class="card is-post">
                        ...
                        <div class="content-wrap">
                            ...
                            <div class="card-heading">
                                <div class="user-block">
                                    <div class="image">
                                        <img src="../assets/img/Home/stella.jpg" data-demo-src="../assets/img/Home/stella.jpg" data-user-popover="2" alt="" />
                                    </div>
                                    <div class="user-info">
                                    ...
                                    <div class="masonry-grid">
                                        ...
                                        <div class="masonry-column-left">
                                            <a data-fancybox="post3" data-lightbox-type="comments" data-thumb="../assets/img/demo/unsplash/3.jpg" href="https://via.placeholder.com/1600x900" data-demo-href="../assets/img/demo/unsplash/3.jpg">
                                                <img src="../assets/img/Home/3.jpg" data-demo-src="../assets/img/Home/3.jpg" alt="" />
                                            </a>
                                            <a data-fancybox="post3" data-lightbox-type="comments" data-thumb="../assets/img/demo/unsplash/4.jpg" href="https://via.placeholder.com/1600x900" data-demo-href="../assets/img/demo/unsplash/4.jpg">
                                                <img src="../assets/img/Home/4.jpg" data-demo-src="../assets/img/Home/4.jpg" alt="" />
                                            </a>
                                        </div>
                                        <!-- Right column -->
                                        <div class="masonry-column-right">
                                            <a data-fancybox="post3" data-lightbox-type="comments" data-thumb=".../assets/img/Home/5.jpg" href="https://via.placeholder.com/1600x900" data-demo-href="../assets/img/Home/5.jpg">
                                                <img src="https://via.placeholder.com/1600x900" data-demo-src="../assets/img/Home/5.jpg" alt="" />
                                            </a>
                                            <a data-fancybox="post3" data-lightbox-type="comments" data-thumb="../assets/img/Home/6.jpg" href="https://via.placeholder.com/1600x900" data-demo-href="../assets/img/Home/6.jpg">
                                                <img src="https://via.placeholder.com/1600x900" data-demo-src="../assets/img/Home/6.jpg" alt="" />
                                            </a>
                                            <a data-fancybox="post3" data-lightbox-type="comments" data-thumb="../assets/img/Home/7.jpg" href="https://via.placeholder.com/1600x900" data-demo-href="../assets/img/Home/7.jpg">
                                                <img src="https://via.placeholder.com/1600x900" data-demo-src="../assets/img/Home/7.jpg" alt="" />
                                            </a>
                                        </div>
                                        <!-- Post actions -->
                                        <!-- /partials/pages/feed/buttons/feed-post-actions.html -->
                            ...
                            <div class="card-footer">
                                ...
                                <div class="likers-group">
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/rolf.jpg" data-user-popover="13" alt="" />
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/mike.jpg" data-user-popover="12" alt="" />
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/daniel.jpg" data-user-popover="3" alt="" />
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/elise.jpg" data-user-popover="6" alt="" />
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/gaelle.jpeg" data-user-popover="4" alt="" />
                                </div>
                        ...
                        <div class="comments-wrap is-hidden">
                            ...
                            <div class="comments-body has-slimscroll">
                                ...
                                <div class="media is-comment">
                                    ...
                                    <div class="media-left">
                                        <div class="image">
                                            <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/jenna.png" data-user-popover="0" alt="" />
                                        </div>
                                    </div>
                                    <!-- Content -->
                                    <div class="media-content">
                                        ...
                                        <div class="media is-comment">
                                            ...
                                            <div class="media-left">
                                                <div class="image">
                                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/stella.jpg" data-user-popover="2" alt="" />
                                                </div>
                                            </div>
                                            <!-- Content -->
                                            <div class="media-content">
                                ...
                                <div class="media is-comment">
                                    ...
                                    <div class="media-left">
                                        <div class="image">
                                            <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/bobby.jpg" data-user-popover="8" alt="" />
                                        </div>
                                    </div>
                                    <!-- Content -->
                                    <div class="media-content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body no-padding">
                            ...
                            <a class="story modal-trigger" data-modal="new-story-modal" >
                                <div class="story-block story-avatar">
                                    <div class="add-overlay">
                                            <span  href="#" class="add-story" id="add-story-button">
                                                <i data-feather="plus"></i>
                                            </span>
                                    </div>
    ...
    <div class="view-wrapper is-full">
        <div id="new-story-modal" style="position: absolute;" class="modal new-story-modal is-medium has-light-bg">
            <div class="modal-background"></div>
            <div class="modal-content" style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);">
                <div class="card">
                    <div class="card-heading">
                        <div class="small-avatar">
                            <img class="avatar" src="../assets/img/Home/jenna.png" data-demo-src="../assets/img/Home/jenna.png" data-user-popover="0" alt="" />
                        </div>
                        <h3>New Story</h3>
                        <!-- Close X button -->
                            ...
                            <div class="columns">
                                <div class="column is-6">
                                    ...
                                    <div class="selection-box modal-trigger" data-modal="video-story-modal">
                                        <div class="box-content">
                                            <img src="../assets/img/Home/video_story.svg" alt="" />
                                            <div class="box-text">
                                ...
                                <div class="column is-6">
                                    ...
                                    <div class="selection-box modal-trigger" data-modal="image-story-modal">
                                        <div class="box-content">
                                            <img src="../assets/img/Home/post_story.svg" alt="" />
                                            <div class="box-text">
                        ...
                        <div class="column is-6">
                            <div class="story-meta">
                                <p>
                                    ...
                                    tamen et nihil remittunt. Sed nimis multa. Sed plane dicit quod
                                    intellegit.
                                </p>
                                <div class="field">
                                    <div class="control">
                                ...
                                <div class="field">
                                    <div class="control buttons">
                                        ...
                                        <button class="button is-solid accent-button raised">
                                            Publish Story
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="left-section">
                            ...
                            <div id="new-group-list" class="user-list has-slimscroll">
                                ...
                                <div class="friend-block" data-ref="ref-6">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/elise.jpg" alt="" />
                                ...
                                <div class="friend-block" data-ref="ref-7">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/bobby.jpg" alt="" />
                                ...
                                <div class="friend-block" data-ref="ref-8">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/lana.jpeg" alt="" />
                                ...
                                <div class="friend-block" data-ref="ref-10">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/mike.jpg" alt="" />
    ...
    <x-book.book-modal></x-book.book-modal>
        ...
        <div class="modal-content">
            ...
            <i data-feather="x"></i>
                ...
                <div class="card-body">
                    ...
                    <div class="action">
                        <button type="button" class="button is-solid accent-button next-modal raised bg-main-light" data-modal="videos-modal">
                            Next
                        </button>
                    </div>
                </div>
                                    ...
                                    <div class="dropdown is-spaced is-right dropdown-trigger">
                                        ...
                                        <div class="dropdown-menu has-margin" role="menu">
                                            <div class="dropdown-content">
                                                ...
                                                <a href="#" class="dropdown-item">
                                                    <div class="media">
                                                        <img src="../assets/img/Home/ninga.svg" data-demo-src="../assets/img/Home/ninga.svg" alt="" />
                                                        <div class="media-content">
                                                            <h3>Css Ninja</h3>
                            ...
                            <div class="tabs-wrapper">
                                ...
                                <div class="tab-content has-slimscroll">
                                    <div class="media is-comment">
                                        <figure class="media-left">
                                            <p class="image is-32x32">
                                                <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/dan.jpg" alt="" data-user-popover="1" />
                                            </p>
                                        </figure>
                                        <div class="media-content">
                                    ...
                                    <div class="media is-comment">
                                        <figure class="media-left">
                                            <p class="image is-32x32">
                                                <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/gaelle.jpeg" alt="" data-user-popover="4" />
                                            </p>
                                        </figure>
                                        <div class="media-content">
                                    ...
                                    <div class="media is-comment">
                                        <figure class="media-left">
                                            <p class="image is-32x32">
                                                <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/rolf.jpg" alt="" data-user-popover="17" />
                                            </p>
                                        </figure>
                                        <div class="media-content">
                ...
                <div class="share-inputs">
                    ...
                    <div id="share-to-page" class="control share-channel-control no-border is-hidden">
                        <div class="page-controls">
                            ...
                            <div class="alias">
                                <img src="https://via.placeholder.com/150x150" data-demo-src="../assets/img/Home/jenna.png" alt="" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="shared-publication">
                        <div class="featured-image">
                            <img id="share-modal-image" src="https://via.placeholder.com/1600x900" alt="" />
                        </div>
                        <div class="publication-meta">
                            <div class="inner-flex">
                                <img id="share-modal-avatar" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/dan.jpg" data-user-popover="1" alt="" />
