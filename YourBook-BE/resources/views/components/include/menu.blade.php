    ...
    <div class="container is-fluid">
        <div class="navbar-brand">
            <a href="/" class="navbar-item">
                <img class="logo light-image" src="../assets/img/navbar/logo.svg" width="112" height="28" alt="" />
                <img class="logo dark-image" src="../assets/img/navbar/logo.svg" width="112" height="28" alt="" />
            </a>
        </div>
            ...
            <div class="navbar-start">
                            ...
                            <div class="nav-drop-body is-friend-requests">
                                ...
                                <div class="media">
                                    <figure class="media-left">
                                        <p class="image">
                                            <img src="../assets/img/Home/bobby.jpg" data-demo-src="../assets/img/Home/bobby.jpg" alt="" />
                                        </p>
                                    </figure>
              ...
              her <a href="#">profile</a>.</span>
                                ...
                                <div class="media">
                                    <figure class="media-left">
                                        <p class="image">
                                            <img src="../assets/img/Home/elise.jpg" data-demo-src="../assets/img/Home/elise.jpg" alt="" />
                                        </p>
                                    </figure>
                                    <div class="media-content">
                                            <span
              ...
              <a href="#">profile</a>.</span>
                                ...
                                <div class="media">
                                    <figure class="media-left">
                                        <p class="image">
                                            <img src="../assets/img/Home/dan.jpg" data-demo-src="../assets/img/Home/dan.jpg" alt="" />
                                        </p>
                                    </figure>
                                    <div class="media-content">
                                            <span
              ...
              you an 2 other people.</span>
                ...
                <div class="navbar-item is-icon drop-trigger">
                    <a class="icon-link is-active" href="javascript:void(0);" style="background-color: #080884;">
                        ...
                        <div class="inner">
                            ...
                            <div class="nav-drop-body is-friend-requests">
                                ...
                                <div class="media">
                                    <figure class="media-left">
                                        <p class="image">
                                            <img src="../assets/img/Home/nelly.png" data-demo-src="../assets/img/Home/nelly.png" data-user-popover="9" alt="" />
                                        </p>
                                    </figure>
                                    <div class="media-content">
                                ...
                                <div class="media">
                                    <figure class="media-left">
                                        <p class="image">
                                            <img src="https://via.placeholder.com/150x150" data-demo-src="../assets/img/Home/dan.jpg" data-user-popover="5" alt="" />
                                        </p>
                                    </figure>
                                    <div class="media-content">
              ...
              should...</span>
                                ...
                                <div class="media">
                                    <figure class="media-left">
                                        <p class="image">
                                            <img src="https://via.placeholder.com/150x150" data-demo-src="../assets/img/Home/dan.jpg" data-user-popover="1" alt="" />
                                        </p>
                                    </figure>
                                    <div class="media-content">
                                        <a href="#">Dan Walker</a>
            ...
            <div class="navbar-end">
                ...
                <div id="account-dropdown" class="navbar-item is-account drop-trigger has-caret">
                    <div class="user-image">
                        <img src="{{auth()->user()->profilePicture()}}" data-demo-src="{{auth()->user()->profilePicture()}}" alt="user" />
                        <span class="indicator"></span>
                    </div>
                    ...
                    <div class="nav-drop is-account-dropdown">
                        <div class="inner">
                            ...
                            <div class="nav-drop-body account-items">
                                <a id="profile-link" href="{{route('profile.show')}}" class="account-item">
                                    <div class="media">
                                        <div class="media-left">
                                            <div class="image">
                                                <img src="{{auth()->user()->profilePicture()}}" data-demo-src="{{auth()->user()->profilePicture()}}" alt="" />
                                            </div>
                                        </div>
                                        <div class="media-content">
                                ...
                                <a class="account-item">
                                    <div class="media">
                                        ...
                                        <div class="media-content" onclick="document.getElementById('logout_form_').submit()" style="cursor:pointer;">
                                            <h3>Log out</h3>
                                            <small>Log out from your account.</small>
                                        </div>
                                        <form method="POST" id="logout_form_" action="{{ route('logout') }}">
                                            @csrf
                                        </form>
                                    </div>
                                </a>
                ...
                <div class="inner">
                    ...
                    <div class="nav-drop-body is-friend-requests">
                        ...
                        <div class="media">
                            <figure class="media-left">
                                <p class="image">
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/Home/bobby.jpg" alt="" />
                                </p>
                            </figure>
                            <div class="media-content">
                                <a href="#">Bobby Brown</a>
                ...
                <div class="inner">
                    ...
                    <div class="nav-drop-body is-friend-requests">
                        ...
                        <div class="media">
                            <figure class="media-left">
                                <p class="image">
                                    <img src="https://via.placeholder.com/150x150" data-demo-src="../assets/img/Home/nelly.png" data-user-popover="9" alt="" />
                                </p>
                            </figure>
                            <div class="media-content">
                                <a href="#">Nelly Schwartz</a>
    ...
    <div class="navbar-menu">
        ...
        <div class="navbar-item has-dropdown is-active">
            <a href="/navbar-v1-profile-main.html" class="navbar-link">
                <img src="../assets/img/Home/jenna.png" data-demo-src="../assets/img/Home/jenna.png" alt="" />
