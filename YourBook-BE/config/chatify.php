...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'YourBook. Chat'),
    ...
    */
    'pusher' => [
        ...
        'options' => [
            ...
            'encrypted' => true,
            'encryption_master_key_base64' => '0x+SefpTtZLDyTR0XzgLH7MzFwuJncNUZatFgzIiaEA=',
        ],
    ],
    ...
    */
    'attachments' => [
        ...
        'allowed_images' => (array) ['png','jpg','jpeg','gif', 'svg', 'webp', 'bmp', 'ico', 'tif', 'tiff'],
        'allowed_files' => (array) ['zip','rar','txt', 'pdf', 'doc', 'docx', 'xlsx', 'xlsm', 'xlsb', 'xltx', 'xls', 'csv', 'ods', 'm4a', 'flac', 'mp3', 'mp4', 'wav', 'wma', 'aac', 'm4b', 'webm',  ],
