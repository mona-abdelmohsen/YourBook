...
class BookController extends Controller
{
    ...
    public function show($book_id): \Illuminate\Http\JsonResponse
    {
        ...
        if($book->count() <= 0){
            return $this->error("Book Does Not Exists",
                null,
    ...
    public function store(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        if($request->category_id){
            ...
            if(!$category){
                return $this->error("This Category do not belongs to this user.",
        ...
        if($request->parent_id){
            ...
            if(!$parentBook){
                return $this->error("You do not own the parent book!",
    ...
    public function update(Request $request, $book_id): \Illuminate\Http\JsonResponse
    {
        ...
        return $this->success("Book Updated",
